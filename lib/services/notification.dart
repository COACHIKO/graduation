  ...
  Future<void> showNotificationEveryFiveMinutes() async {
    showNotification(
       ...
       interval: 60,
        ...
        body: "Select from below your current activity",
         actionButtons: [
          NotificationActionButton(key: 0.toString(), label: "Sleeping",color: Colors.red),
          NotificationActionButton(key: 1.toString(), label: "Studying",),
          NotificationActionButton(key: 2.toString(), label: "Training",color: Colors.blueAccent),
                       ]
    );
  }
